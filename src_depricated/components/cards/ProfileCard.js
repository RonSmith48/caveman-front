      ...
      <Grid container justifyContent="space-between" alignItems="center" sx={{ position: 'relative', zIndex: 5 }}>
        <Grid item>
          <Stack direction="row" spacing={matchDownSM ? 1 : 2} alignItems="center">
            ...
            <Stack spacing={0.75}>
              <Typography variant="h5">You&apos;re almost done</Typography>
              <Typography variant="body2" color="secondary">
                Complete your profile for a personalised dashboard. <br />
                Add your <span style={{ fontWeight: 'bold', color: 'black' }}>primary role</span> to stop seeing this message.
              </Typography>
            </Stack>
          </Stack>
        </Grid>
        <Grid item sx={{ mx: matchDownSM ? 2 : 3, my: matchDownSM ? 1 : 0, mb: matchDownSM ? 2 : 0 }} xs={matchDownSM ? 12 : 'auto'}>
          <Button variant="contained" fullWidth={matchDownSM} component={Link} to="/account/profile" onClick={focusInput}>
            Edit Your Profile
          </Button>
        </Grid>
      </Grid>

...
function ReactTable({ columns, data }) {
  ...
  const {
  ...
  } = useTable(
    {
      ...
      data,
      filterTypes,
      initialState: { pageIndex: 0, pageSize: 50, selectedRowIds: {} }
    },
    useFilters,
    usePagination,
    useRowSelect,
  ...
  return (
    <>
      <MainCard title="FIRING - Requires shiftboss verification" content={false} secondary={<VerifyUpdatesButton />}>
        <ScrollX>
...
const ProdLevelUpdatesFiring = ({ data, striped, title }) => {
...
ProdLevelUpdatesFiring.propTypes = {
  data: PropTypes.any,
  striped: PropTypes.bool,
  title: PropTypes.string
};

export default ProdLevelUpdatesFiring;

...
import BDCFDefineGroups from './bdcf-entry-group2';
import BDCFExistingGroups from 'sections/tables/bdcf-existing-groups';
import * as Yup from 'yup';

const BDCFEntryGroupTab = () => {
...
export default BDCFEntryGroupTab;

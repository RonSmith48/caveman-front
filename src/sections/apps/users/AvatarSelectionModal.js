...
// List of SVG avatar filenames (all SVGs stored in /public/assets/images/users/)
// currently 41 avatars.
...
const AvatarSelectionModal = ({ isOpen, handleClose, handleSelect }) => {
  ...
  const handleAvatarClick = (avatar) => {
    ...
    handleSelect(avatar); // Send selected avatar to parent component
  };

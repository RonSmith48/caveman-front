...
const FireEditModal = ({ open, onClose, location_id, handleSelectOredrive, od }) => {
                      ...
                      <TableCell>
                        {change.activated && (
                          <Tooltip title={change.activated?.full_name}>
                            ...
                            >
                              <SvgAvatar src={change.activated?.avatar} alt={change.activated?.full_name} size={SM_AVATAR_SIZE} />
                            </div>
                          </Tooltip>
                        )}
                      </TableCell>
                      <TableCell>
                        {change.deactivated && (
                          <Tooltip title={change.deactivated?.full_name}>
                            ...
                            >
                              <SvgAvatar src={change.deactivated?.avatar} alt={change.deactivated?.full_name} size={SM_AVATAR_SIZE} />
                            </div>
                          </Tooltip>
                        )}
                      </TableCell>

  ...
  <Page size="A4" orientation="portrait" style={styles.page}>
    <View style={styles.headerRow}>
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.subTitle}>for rings fired {formatDate(reportDate)}</Text>
      </View>
    ...
    <View style={styles.tableHeader}>
      ...
      <Text style={styles.cell}>Copper (%)</Text>
      <Text style={styles.cell}>Gold (g/t)</Text>
      <Text style={styles.cell}>Density</Text>
    </View>
    ...
    {data.map((ring, index) => (
      <View key={index} style={styles.row}>
        ...
        <Text style={styles.cell}>{parseFloat(ring.copper).toFixed(2)}</Text>
        <Text style={styles.cell}>{parseFloat(ring.gold).toFixed(2)}</Text>
        <Text style={styles.cell}>{parseFloat(ring.density).toFixed(3)}</Text>
      </View>
    ))}
